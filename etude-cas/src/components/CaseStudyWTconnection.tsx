...
const CaseStudyWTconnection: React.FC<Props> = ({ }) => { 
  ...
  return (
    <div id="main">
      <div id="profile">
        <Button variant="contained" onClick={() => console.log("You clicked")}>Se Connecter</Button>
      </div>
